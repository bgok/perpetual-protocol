...
// FIXME Get from an environmental variable
export const TBSC_URL = "https://data-seed-prebsc-1-s1.binance.org:8545/"
...
// FIXME Get from an environmental variable
export const TBSC_MNEMONIC = "<wallet words go here>"
